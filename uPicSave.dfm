object frmPicSave: TfrmPicSave
  ...
  object Label2: TLabel
    ...
    Width = 365
    Height = 15
    Caption = 'Selecionar o campo que cont'#233'm as imagens a serem recuperadas :'
    Font.Charset = DEFAULT_CHARSET
    Font.Color = clWindowText
    Font.Height = -12
    Font.Name = 'Segoe UI'
  ...
  object Label5: TLabel
    ...
    Width = 281
    Height = 15
    Caption = 'Suporta os tipos de imagem: JPEG, BMP, PNG, e TIF'
    Font.Charset = DEFAULT_CHARSET
    Font.Color = clWindowText
    Font.Height = -12
    Font.Name = 'Segoe UI'
